...
**Windows PowerShell:**
```powershell
$env:DATABASE_URL="user:password@tcp(host:3306)/database"
```

**Linux/Mac:**
```bash
export DATABASE_URL="user:password@tcp(host:3306)/database"
```
...
```bash
go mod tidy
go run . -db "user:password@tcp(host:3306)/database"
```
